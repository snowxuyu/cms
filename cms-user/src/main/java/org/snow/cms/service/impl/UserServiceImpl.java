...
/*     */ 
/*  39 */     Integer[] arr$ = roleIds; int len$ = arr$.length; for (int i$ = 0; i$ < len$; i$++) { int roleId = arr$[i$].intValue();
...
/*     */     }
/*     */ 
/*  77 */     Integer[] arr$ = groupIds; int len$ = arr$.length; for (int i$ = 0; i$ < len$; i$++) { int gid = arr$[i$].intValue();
