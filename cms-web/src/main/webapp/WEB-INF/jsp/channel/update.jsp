...
$(function(){
	...
	$("input:radio").click(function() {
		var rvalue = $("input:radio:checked").val();
		if (0==rvalue) {
			$("#linkUrl").attr("disabled",true);
		} else {
...
<div id="content">
	...
	<table width="550px" cellspacing="0" cellPadding="0">
		...
		<tr>
			...
			<td><input id="linkUrl" name="customLinkUrl" size="50"></td>
		</tr>
		<tr>
			<td class="rightTd">栏目类型:</td>
			<td><sf:select path="type">
				<sf:option  value="0">导航栏目</sf:option>
				<sf:option  value="1">文章列表栏目</sf:option>
				<sf:option  value="2">文章内容栏目</sf:option>
				<sf:option  value="3">图片列表栏目</sf:option>
			</sf:select></td>
		</tr>
		<tr>
